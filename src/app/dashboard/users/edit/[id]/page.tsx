...
export default function EditUserPage() {
  ...
  return (
    <div className="p-6 space-y-4 max-w-md mx-auto">
      ...
      <Input placeholder="مکان" value={location} onChange={(e) => setLocation(e.target.value)} />
      <Button type="submit" disabled={loading} onClick={handleUpdate} className='cursor-pointer'>
